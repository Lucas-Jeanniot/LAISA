...
class ChatApp:
    def __init__(self, root):
        ...
        self.send_menu.add_command(label="RAG Search", command=self.set_rag_mode)
    ...
    def retry_message(self):
        ...
        if self.current_mode == "Send":
            ...
            self.rag_search(self.last_user_message)
    ...
    def rag_search(self, user_message):
        ...
        self.add_message(f"RAG search for: {user_message}", "System")
